...
// App.jsx could have methods (bound event handler functions) on the class which will be passed down to children 
// components via props (the children components, presentational components, will have event listeners 
// that will fire off the bound event handler functions
//     App.jsx could render the dropdown menu as well as the Table Component (presentational component)
export default Grid;

// App.jsx could have methods (bound event handler functions) on the class which will be passed 
// down to children components via props (the children components, presentational components, 
// will have event listeners that will fire off the bound event handler functions.
// App.jsx could render the dropdown menu as well as the Table Component (presentational component)
